...
//A compiler error because 'foo' is declared inside the loop's scope.
...
//'x' is defined in a scope accessible to both loop and print statement outside loop.
//foo variable in the previous example was declared inside the loop's scope.
